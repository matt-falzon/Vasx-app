...
function SudsClient(_options) {
  ...
  var config = extend({
    ...
    envelopeBegin: '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ser="http://service.adminportal.vasx.com/"><soapenv:Header/><soapenv:Body>',
    envelopeEnd: '</soap:Body></soapenv:Envelope>'
  },_options);
