...
/**
 The base class for all VAS_Xapp modules
 */
...
/**
 VAS_Xapp Platform calls this method on startup.
 */
-(void)startup;

/**
 VAS_Xapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 VAS_Xapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 VAS_Xapp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 VAS_Xapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
