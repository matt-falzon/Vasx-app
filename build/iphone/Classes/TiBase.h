...
// in simulator we redefine to format for VAS_Xapp Developer console
...
{\
	NSString * exceptionName = [@"org.vas_xapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vas_xapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVAS_XappNativeItemNone = -1, 
	UIVAS_XappNativeItemSpinner = -2,
	UIVAS_XappNativeItemProgressBar = -3,
	
	UIVAS_XappNativeItemSlider = -4,
	UIVAS_XappNativeItemSwitch = -5,
	UIVAS_XappNativeItemMultiButton = -6,
	UIVAS_XappNativeItemSegmented = -7,
	
	UIVAS_XappNativeItemTextView = -8,
	UIVAS_XappNativeItemTextField = -9,
	UIVAS_XappNativeItemSearchBar = -10,
	
	UIVAS_XappNativeItemPicker = -11,
	UIVAS_XappNativeItemDatePicker = -12,
	
	UIVAS_XappNativeItemInfoLight = -13,
	UIVAS_XappNativeItemInfoDark = -14,
	
	UIVAS_XappNativeItemDisclosure = -15,
	
	UIVAS_XappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VAS_Xapp instances of
