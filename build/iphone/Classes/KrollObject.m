...
//@interface VAS_XappObject : NSObject
//@end

@interface VAS_XappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VAS_XappObject class]])
		{
			for (NSString *key in [[(VAS_XappObject*)o modules] allKeys])
			{
